...
ALLOWED_USER_TYPES = ["operator"] # 운영자용 백엔드

AUTH_USER_MODEL = "accounts.OperatorUser"
...
ROOT_URLCONF = "backoffice-api.urls"
...
WSGI_APPLICATION = "backoffice-api.wsgi.application"
