...
class OwnerUser(AbstractUser):
    ...
    phone_number = models.CharField(
        max_length=20, unique=True, blank=False, null=False, verbose_name="Phone Number"
    )
    business_license = models.CharField(
        max_length=50, blank=True, verbose_name="Business License Number"
    )
    store_name = models.CharField(max_length=100, blank=True, verbose_name="Store Name")
...
class OperatorUser(AbstractUser):
    ...
    employee_id = models.CharField(
        max_length=20, unique=True, blank=False, null=False, verbose_name="Employee ID"
    )
...
class User(AbstractUser):
    ...
    phone_number = models.CharField(
        max_length=20, unique=True, blank=True, null=True, verbose_name="Phone Number"
    )
