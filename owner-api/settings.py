...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "배달 플랫폼 점주용 API 서버",
    "VERSION": "1.0.0",
    "SERVE_INCLUDE_SCHEMA": False,
    "SERVERS": [
        {"url": "/api/owner", "description": "Owner API Server"},
    ],
}
...
WSGI_APPLICATION = "owner-api.wsgi.application"
